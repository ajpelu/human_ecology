...
<<<<<<< HEAD
1. I'm not sure that the RQ1 (Research question 1) and RQ2 should be separated, because I think they are the same model. The only difference would be how we interpreted the effects of several variables. Let have the following model:
$$Richness \sim elevation + sr.spr + \ldots + pH + \ldots + transh + commons$$
